...
##------------------------------------------------------------------------------------
# 
# We need to use this method for the time being as the fit generator does not provide 
# EASY access to the output in Keras call backs. 
# By training in batches, we pass a batch through the network, pick up the generated RoI
# detections and bounding boxes and generate our semantic / gaussian tensors ...
# 
