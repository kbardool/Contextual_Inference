...
###############################################################
def fpn_mask_graph(rois, feature_maps,
                         image_shape, pool_size, num_classes):
    """
...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        # and zero padded.
        #
        # If training generate 2000 proposals, otherwise 1000
        #----------------------------------------------------------------------------                        
        ...
        if mode == "training":
            ...
            mrcnn_class_logits, mrcnn_class, mrcnn_bbox =\
                         fpn_classifier_graph(rois, mrcnn_feature_maps, 
                                              config.IMAGE_SHAPE,config.POOL_SIZE, config.NUM_CLASSES)

            mrcnn_mask = fpn_mask_graph(rois, mrcnn_feature_maps,
                                              config.IMAGE_SHAPE,config.MASK_POOL_SIZE,config.NUM_CLASSES)
